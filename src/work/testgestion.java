				...
				if (e.getSource()==button) {
					{
			        	...
			        	
			            {
							...
							String choiceField2 = (String)cb.getSelectedItem();
				            ...
				            System.out.println(choiceField2);
				            
				                
			            Class.forName("com.mysql.cj.jdbc.Driver"); 
			            Connection conn = DriverManager.getConnection(url, username, password);
			            Statement stmt = conn.createStatement();
			            String sql = "INSERT INTO SAV (ID_SAV, Prenom, Nom, Telephone, Date, Num_ticket, Etat_tic, Declaration) VALUES (NULL,'" + prenomField +  "', '"+ nomField + "','" + numField + "','" + dateField + "', "+ rand_tic + ", '"+ choiceField +"', '"+  choiceField2 +"');";
